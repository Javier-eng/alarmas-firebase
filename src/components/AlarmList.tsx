      ...
      <div className="grid gap-4">
        {alarms.length === 0 ? (
          ...
          alarms.map((alarm) => (
            ...
            >
              <div>
                <div className="text-2xl font-black text-gray-800 leading-none">{alarm.time}</div>
                <div className="text-xs font-semibold text-blue-600 uppercase mt-1 tracking-wide">{alarm.date}</div>
